...
/*
CREATE USER 'paracrawl_user'@'localhost' IDENTIFIED BY 'Ldsi4Jd+3';
...
mysql -u paracrawl_user -pLdsi4Jd+3 -Dparacrawl < create.sql
mysqldump -u paracrawl_user -pLdsi4Jd+3 --databases paracrawl | xz -c > db.xz
xzcat db.xz | mysql -u paracrawl_user -pLdsi4Jd+3 -Dparacrawl
